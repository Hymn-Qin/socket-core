...
/**
 * A {@link ProtocolDecoder} that cumulates the content of socketCallback buffers to a
 * <em>cumulative buffer</em> to help users implement decoders.
 * <p>
 * If the socketCallback {@link IoBuffer} is only a part of a message. decoders should
 * cumulate socketCallback buffers to make a message complete or to postpone decoding
