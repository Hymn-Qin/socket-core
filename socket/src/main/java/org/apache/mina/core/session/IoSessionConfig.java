...
public interface IoSessionConfig {
     ...
     * is enabled.  If enabled, all socketCallback messages are stored in an internal
     * {@link BlockingQueue} so you can read socketCallback messages in more
     ...
     * socketCallback messages are stored in an internal {@link BlockingQueue} so you
     * can read socketCallback messages in more convenient way for client
