...
public interface SingleSessionIoHandler {
    ...
    /**
     * Invoked when protocol message is socketCallback. Implement your protocol flow
     * here.
     *
     * @param message the socketCallback message
     * @throws Exception If the socketCallback message can't be processed
